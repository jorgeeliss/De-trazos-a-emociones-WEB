...
import { Upload, X, ArrowRight, ArrowLeft, RefreshCw, AlertCircle, Sparkles, CheckCircle, Activity, HeartPulse, LogOut, User } from 'lucide-react';
...
const Analyzer = () => {
  ...
  return (
    <div className="analyzer-wrapper" style={{ position: 'relative' }}>
      <div style={{ position: 'absolute', top: '20px', right: '20px', zIndex: 100 }}>
        <div 
          ...
          style={{
            ...
            borderRadius: '50%',
            border: '1px solid rgba(139, 121, 242, 0.3)',
            transition: 'all 0.2s',
        ...
        {showUserMenu && (
          <div style={{
            ...
            <div style={{ paddingBottom: '12px', borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <div style={{ fontSize: '14px', fontWeight: 600, color: '#fff' }}>{user.firstname || user.nombre || 'Usuario'}</div>
              <div style={{ fontSize: '12px', color: 'var(--muted)', marginTop: '4px', wordBreak: 'break-all' }}>{user.email || 'Sin correo'}</div>
            </div>
